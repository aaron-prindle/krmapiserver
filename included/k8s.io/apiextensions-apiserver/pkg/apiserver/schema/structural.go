...
// Extensions contains the Kubernetes OpenAPI v3 included extensions.
...
// under a logical junctor, and catch all structs for generic and included extensions schema fields.
