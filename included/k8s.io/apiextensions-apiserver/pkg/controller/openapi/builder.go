...
import (
	...
	v1 "github.com/aaron-prindle/krmapiserver/included/k8s.io/api/autoscaling/v1"
	...
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/apiserver/pkg/endpoints"
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/apiserver/pkg/endpoints/openapi"
	openapibuilder "github.com/aaron-prindle/krmapiserver/included/k8s.io/kube-openapi/pkg/builder"
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/kube-openapi/pkg/common"
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/kube-openapi/pkg/util"

	"github.com/aaron-prindle/krmapiserver/included/k8s.io/apiextensions-apiserver/pkg/apis/apiextensions"
	generatedopenapi "github.com/aaron-prindle/krmapiserver/included/k8s.io/apiextensions-apiserver/pkg/generated/openapi"
)
...
const (
	...
	listMetaType        = "github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"
	typeMetaType        = "github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"
