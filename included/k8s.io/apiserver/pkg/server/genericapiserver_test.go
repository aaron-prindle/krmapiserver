...
import (
	...
	openapi "github.com/aaron-prindle/krmapiserver/included/github.com/go-openapi/spec"
	...
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/apiserver/pkg/apis/example"
	...
	kubeopenapi "github.com/aaron-prindle/krmapiserver/included/k8s.io/kube-openapi/pkg/common"
)
...
func testGetOpenAPIDefinitions(_ kubeopenapi.ReferenceCallback) map[string]kubeopenapi.OpenAPIDefinition {
	return map[string]kubeopenapi.OpenAPIDefinition{
		"github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.Status":          {},
		"github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.APIVersions":     {},
		"github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.APIGroupList":    {},
		"github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.APIGroup":        buildTestOpenAPIDefinition(),
		"github.com/aaron-prindle/krmapiserver/included/k8s.io/apimachinery/pkg/apis/meta/v1.APIResourceList": {},
	}
}
