...
import (
	...
	"github.com/aaron-prindle/krmapiserver/included/k8s.io/apiserver/plugin/pkg/audit/fake"
	// Importing just for the schema definitions.
	_ "github.com/aaron-prindle/krmapiserver/included/k8s.io/apiserver/plugin/pkg/audit/webhook"
)
