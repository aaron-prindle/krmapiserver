...
// a model / Go type. If a Go type is includeded from another package, only the path after "/included/"
...
//
// Example for includeded Go type:
//     Original full path:  k8s.io/kubernetes/included/k8s.io/api/core/v1.Pod
