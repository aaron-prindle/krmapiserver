...
import fmt "fmt"
import math "math"
import google_protobuf "github.com/aaron-prindle/krmapiserver/included/github.com/golang/protobuf/ptypes/any"
...
type ApiKeySecurity struct {
	...
	VendorExtension []*NamedAny `protobuf:"bytes,5,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type BasicAuthenticationSecurity struct {
	...
	VendorExtension []*NamedAny `protobuf:"bytes,3,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type BodyParameter struct {
	...
	VendorExtension []*NamedAny `protobuf:"bytes,6,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Contact struct {
	...
	VendorExtension []*NamedAny `protobuf:"bytes,4,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Document struct {
	...
	VendorExtension     []*NamedAny            `protobuf:"bytes,16,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type FileSchema struct {
	...
	VendorExtension []*NamedAny   `protobuf:"bytes,10,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type FormDataParameterSubSchema struct {
	...
	VendorExtension  []*NamedAny      `protobuf:"bytes,23,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Header struct {
	...
	VendorExtension  []*NamedAny      `protobuf:"bytes,19,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type HeaderParameterSubSchema struct {
	...
	VendorExtension  []*NamedAny      `protobuf:"bytes,22,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Info struct {
	...
	VendorExtension []*NamedAny `protobuf:"bytes,7,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Operation struct {
	...
	Security        []*SecurityRequirement `protobuf:"bytes,12,rep,name=security" json:"security,omitempty"`
	VendorExtension []*NamedAny            `protobuf:"bytes,13,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Paths struct {
	VendorExtension []*NamedAny      `protobuf:"bytes,1,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
...
type PrimitivesItems struct {
	...
	Enum             []*Any           `protobuf:"bytes,16,rep,name=enum" json:"enum,omitempty"`
	MultipleOf       float64          `protobuf:"fixed64,17,opt,name=multiple_of,json=multipleOf" json:"multiple_of,omitempty"`
	VendorExtension  []*NamedAny      `protobuf:"bytes,18,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Responses struct {
	...
	VendorExtension []*NamedAny           `protobuf:"bytes,2,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
...
type Schema struct {
	...
	VendorExtension      []*NamedAny               `protobuf:"bytes,31,rep,name=included_extension,json=includedExtension" json:"included_extension,omitempty"`
}
