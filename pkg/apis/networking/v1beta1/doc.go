...
// +k8s:defaulter-gen-input=../../../../included/k8s.io/api/networking/v1beta1
// +groupName=networking.k8s.io

package v1beta1 // import "github.com/aaron-prindle/krmapiserver/pkg/apis/networking/v1beta1"
