...
// +k8s:defaulter-gen-input=../../../../included/k8s.io/api/auditregistration/v1alpha1

// +groupName=auditregistration.k8s.io

package v1alpha1 // import "github.com/aaron-prindle/krmapiserver/pkg/apis/auditregistration/v1alpha1"
